...
class Nine_poke():
    ...
    def __init__(self, port, rising_event_1 = 'poke_1', falling_event_1 = 'poke_1_out',
        ...
        self.poke_7 = _Poke(self.mcp.Pin('A6'), self.mcp.Pin('B6'), rising_event_4, falling_event_4, debounce)
        self.poke_8 = _Poke(self.mcp.Pin('A7'), port.POW_A        , rising_event_5, falling_event_5, debounce)
        self.poke_9 = _Poke(self.mcp.Pin('B7'), port.POW_B        , rising_event_6, falling_event_6, debounce)